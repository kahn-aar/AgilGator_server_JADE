...
public class BDDAgent extends Agent {
	...
	private static final String PASSWORD = "Meriel95"; //Mot de passe de la BDD agilgatormonkey28
	...
	public Connection connectDatabase()
	{
		try {
			...
			if(connection==null){
				connection = DriverManager.getConnection("jdbc:mysql://localhost", this.USERNAME, this.PASSWORD);
			}
