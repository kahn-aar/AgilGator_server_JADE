...
// Behaviour qui attend une demande liée à une sous-tâche
public class WaitingSubTaskBehaviour extends Behaviour{
	...
	public WaitingSubTaskBehaviour(DeviceInfoTypes demande, Utilisateur user, SubTask soustache){
